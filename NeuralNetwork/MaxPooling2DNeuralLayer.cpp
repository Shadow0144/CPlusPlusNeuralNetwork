...
MaxPooling2DNeuralLayer::MaxPooling2DNeuralLayer(NeuralLayer* parent, const std::vector<size_t>& filterShape, bool hasChannels)
	: PoolingNeuralLayer(parent, 2, filterShape, hasChannels)
{
