...
AveragePooling1DFunction::AveragePooling1DFunction(size_t filterSize, size_t stride)
{
	this->hasBias = false;
...
void AveragePooling1DFunction::draw(ImDrawList* canvas, ImVec2 origin, double scale)
{
