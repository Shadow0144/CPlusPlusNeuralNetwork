...
ImageClassVisualizer::~ImageClassVisualizer()
{
	delete classColors;
}

xt::xarray<size_t> ImageClassVisualizer::convertToIndices(const xt::xarray<double>& predicted)
{
...
void ImageClassVisualizer::draw(ImDrawList* canvas, const xt::xarray<double>& predicted, const xt::xarray<double>& actual)
{
