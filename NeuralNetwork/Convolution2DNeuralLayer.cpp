...
void Convolution2DNeuralLayer::addChildren(NeuralLayer* children)
{
...
xt::xarray<double> Convolution2DNeuralLayer::feedForward(const xt::xarray<double>& input)
{
	// Assume the last dimension is the channel dimension
...
xt::xarray<double> Convolution2DNeuralLayer::feedForwardTrain(const xt::xarray<double>& input)
{
	lastInput = input;
...
xt::xarray<double> Convolution2DNeuralLayer::backPropagate(const xt::xarray<double>& sigma)
{
...
double Convolution2DNeuralLayer::applyBackPropagate()
{
...
std::vector<size_t> Convolution2DNeuralLayer::getOutputShape()
{
...
void Convolution2DNeuralLayer::draw(ImDrawList* canvas, ImVec2 origin, double scale, bool output)
{
	...
	draw2DConvolution(canvas, origin, scale);
...
void Convolution2DNeuralLayer::draw2DConvolution(ImDrawList* canvas, ImVec2 origin, double scale)
{
